...
public class UsuarioController {
    ...
    @PostMapping("/login") //Cambiar a una entidad para loguearse
    public ResponseEntity<String> login(@RequestParam String email, @RequestParam String clave) {
        boolean autenticado = usuarioService.verificarLogin(email, clave);
        if (autenticado) {
